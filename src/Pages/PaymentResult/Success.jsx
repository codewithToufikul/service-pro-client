  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      ...
      <div className="max-w-xl mx-auto my-16 bg-white rounded-xl shadow p-8 text-center">
        ...
        <p className="mt-2 text-gray-600">Thank you! Your payment has been validated.</p>
        {tranId && <p className="mt-2 text-sm text-gray-500">Transaction ID: {tranId}</p>}
        <div className="mt-6 flex gap-3 justify-center">
          <Link to="/payment-history" className="px-4 py-2 bg-blue-600 text-white rounded">View History</Link>
