      ...
      <footer className="max-w-7xl mx-auto p-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <img className="w-44" src={footerLogo} alt="Service Pro Logo" />
            <p className="text-gray-600">
              North Zone B, LP 80/2, Road No. 276 <br />
              Khalishpur, Khulna 9000, Bangladesh
            </p>
            <div className="flex space-x-4 pt-2">
              <a href="https://www.facebook.com/profile.php?id=61575864260668" className="text-gray-600 hover:text-blue-600">
              ...
              <a href="https://www.instagram.com/servicepro24x?igsh=MXI1bzZzOWNlZDYwaQ==" className="text-gray-600 hover:text-pink-600">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-col space-y-2">
              ...
              <Link to="/contract" className="text-gray-600 hover:text-blue-600 transition-colors">
                Contact
              </Link>
            </div>
          </div>
          ...
          {/* Legal Links */}
          <div className="space-y-4">
            <h6 className="text-lg font-semibold text-gray-900">Legal</h6>
            <div className="flex flex-col space-y-2">
              <Link to="/terms-condition" className="text-gray-600 hover:text-blue-600 transition-colors">
                Terms & Conditions
              </Link>
          ...
          {/* Newsletter */}
          <div className="space-y-4">
            <h6 className="text-lg font-semibold text-gray-900">Stay Connected</h6>
